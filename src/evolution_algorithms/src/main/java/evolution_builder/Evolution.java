 ...
 * @author main
 */
public class Evolution<P> {

    private final EvolutionPhases<P> components;
    private final boolean withPercentOfFitness;

    private Population<P> population;
    private PopulationPerson<P> totalBestPopulationPerson = null;
    private boolean earlyStopped = false;

    public Evolution(Population<P> population, boolean withPercentOfFitness, EvolutionPhases<P> components) {
    ...
    public PopulationPerson<P> getTotalBestPerson() {
    ...
    public Population<P> startEvolution(int epochs) {
        if (epochs < 1) {
    ...
    public Population<P> startEvolution(int epochs, EvolutionStage<P> stage) {
...
//            lastRunningTime = System.nanoTime() - first;
    ...
    private void computeFitnessForPopulation() {
        ...
        PopulationPerson<P> populationBest = population.getBestPerson();

...
public class Recombination {
    ...
    public static <T, P> Population<P> fixed(Population<P> population, final int BREAK_SIZE, Genes<T, P> genes) {
        ...
        while (personCount < populationSize) {
            ...
            recombine(populationPerson1, populationPerson2, genes, BREAK_SIZE, genesCount);
...
//        }
    ...
    private static <T, P> void recombine(
        PopulationPerson<P> populationPerson1, PopulationPerson<P> populationPerson2, Genes<T, P> genes, int breakSize,
        int genesCount
    ) {
